...
export default class App extends React.Component {
  ...
  componentDidMount() {
    fetch('https://api.github.com/users/DavidHall-Code')
    .then((res) => res.json())
    .then(data => {
    ...
    axios
      .get(
        "https://api.github.com/users/DavidHall-Code/followers"
      )
      .then((res) => {
        this.setState({
  ...
  return (
    <div className="App">
      ...
      {this.state.value === '' ? <><h3>DavidHall-Code's Contribution Chart</h3><img src='https://ghchart.rshah.org/DavidHall-Code' alt="username's Github chart" /></> :
